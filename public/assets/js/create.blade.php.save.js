...
let documentReady = () => {
    ...
    simplemdeBody.codemirror.setOption("extraKeys", {
        ...
        'Ctrl-L': function(cm) {
            insertTextAtCurrentLine(cm, '<!--prettify lang=js linenums=true-->', 'js');
        },
        'Ctrl-M': function(cm) {
            insertTextAtCurrentLine(cm, '<small>caption</small>', 'caption');
        }
    });        
